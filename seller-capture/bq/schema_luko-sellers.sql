-- Luko Seller Capture & Enrichment — BigQuery schema (project: luko-sellers, dataset: luko_sellers)
-- Generated from schema.sql via sed. If you change schema.sql, regenerate this file.

-- Raw captures: append-only event log
CREATE TABLE IF NOT EXISTS `luko-sellers.luko_sellers.sellers_raw` (
...
CREATE TABLE IF NOT EXISTS `luko-sellers.luko_sellers.sellers_enriched` (
  seller_id                STRING NOT NULL,
  marketplace              STRING,
...
CREATE TABLE IF NOT EXISTS `luko-sellers.luko_sellers.action_log` (
...
CREATE TABLE IF NOT EXISTS `luko-sellers.luko_sellers.agency_blacklist` (
...
CREATE OR REPLACE VIEW `luko-sellers.luko_sellers.worklist_v` AS
SELECT
...
CREATE OR REPLACE VIEW `luko-sellers.luko_sellers.worklist_de_inactive_v` AS
SELECT
...
CREATE OR REPLACE VIEW `luko-sellers.luko_sellers.warehouse_pl_v` AS
SELECT
  seller_id, marketplace, business_name, business_address, country,
  vat, registry_id, phone_raw, email_raw,
  status, jurisdiction_reason,
...
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS weee_number STRING;
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS lucid_id STRING;
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS de_operating_signals ARRAY<STRING>;
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS jurisdiction_segment STRING;
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS jurisdiction_reason STRING;
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS outreach_priority STRING;
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS officers STRING;
-- ALTER TABLE `luko-sellers.luko_sellers.sellers_enriched` ADD COLUMN IF NOT EXISTS notes STRING;
